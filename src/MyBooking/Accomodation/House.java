...
/**
 *  Η κλαση House ειναι μια υποκλαση της υπερκλασης Accommodation που δημιουργει ενα καταλυμα(House). Η κλαση κληρονομει ολα τα
...
public class House extends Accomodation {
     ...
     *  κληρονομει η κλαση House απο την υπερκλαση της(Accommodation).Επισης στον κατασκευαστη της κλασης διμιουργηται και ενα αντικειμενο
     *  accommodationImage που ειναι τυπου ImageLoader οπου χρησιμοποιτηται για την "φορτωση" των εικονων των House καταλυματων.Η χρηση της κληρονομικοτητας
     *  επιτιγχανεται με της εντολη "super".
     */

    public House(String name, int price, int meter2, boolean wifi, boolean parking, boolean breakfast, boolean longTerm, String providerCode){
        super();
        this.id = ++code;
        this.name = name;
        this.price = price;
    ...
    public String accommodationsToString(){
        return "HOUSE|"+ name + "|" + price + "|"  +  meter2 + "|" + wifi + "|" + parking + "|" + breakfast + "|" + longTerm + "|" + deleted + "|" + providerCode;
    }
